...
CONTACT INFORMATION
-------------------
Email: ${analysis.email || "Not detected"}
Phone: ${analysis.phone || "Not detected"}

EDUCATION
---------
${formatReportList(analysis.education_keywords)}

EXPERIENCE
----------
${formatReportList(analysis.experience_mentions)}

ATS SCORE BREAKDOWN
-------------------
${formatReportBreakdown(ats.breakdown || {})}

AI RECOMMENDATIONS
------------------
Priority: ${suggestionsData.priority || "Review"}

${formatReportList(suggestionsData.suggestions)}

RESUME TEXT
-----------
${data.extracted_text || "No extracted text available."}
...
`;
    ...
    link.download =
        `${removeExtension(data.filename || "resume")}_analysis.txt`;
